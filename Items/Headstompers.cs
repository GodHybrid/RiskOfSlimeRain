...
namespace RiskOfSlimeRain.Items
{
	class Headstompers : ModItem
	{
		...
		{
			TooltipLine line = new TooltipLine(mod, "Stompers", "Combat Ready Spikeshoes, lovingly named 'Headstompers', allow you to get the drop on foes. \nLiterally. Vertically.");
			tooltips.Add(line);
			foreach (TooltipLine line2 in tooltips)
			{
				if (line2.Name == "Stompers")
				{
		...
		{
			player.GetModPlayer<RORPlayer>().stompers++;
			return true;
		}
