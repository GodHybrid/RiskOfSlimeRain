...
{
	public class ShacklesSlowdownNPCEffect : NPCEffect
	{
		public override void AI(NPC npc)
		{
			if (npc.velocity.X > 1f) npc.velocity.X *= 0.8f;
		}

		public override void PostDraw(NPC npc, SpriteBatch spriteBatch, Color drawColor)
		{
			Vector2 drawCenter = new Vector2(npc.Center.X, npc.Top.Y + npc.gfxOffY - 25) - Main.screenPosition;
